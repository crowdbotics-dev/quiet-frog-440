"""
Django settings for quiet_frog_440 project.
...
ROOT_URLCONF = 'quiet_frog_440.urls'
...
WSGI_APPLICATION = 'quiet_frog_440.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_frog_440 API",
    "DESCRIPTION": "API documentation for quiet_frog_440 App",
    "VERSION": "v1",
}
